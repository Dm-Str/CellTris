...
img_obj1 = PhotoImage(file='img/bg1.png')
...
grid = [game_sc.create_rectangle(x * TILE, y * TILE, x * TILE + TILE,
...
sc.create_text(505, 30, text='CELLTRIS', font=('NeoTrash', 40), fill='red', anchor=NW)
sc.create_text(535, 780, text='score', font=('NeoTrash', 45), fill='white', anchor=NW)
sc.create_text(525, 650, text='record', font=('NeoTrash', 45), fill='white', anchor=NW)
_score = sc.create_text(550, 840, text=str(score), font=('NeoTrash', 35), fill='red', anchor=NW)
_record = sc.create_text(550, 710, text=record, font=('NeoTrash', 35), fill='red', anchor=NW)

get_color = lambda: (randrange(210, 220), randrange(38, 39), randrange(1, 2))
