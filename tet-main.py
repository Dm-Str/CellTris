...
sc.create_text(550, 840, text=str(score), font=('NeoTrash', 35), fill='red', anchor=NW)
sc.create_text(550, 710, text=record, font=('NeoTrash', 35), fill='red', anchor=NW)

get_color = lambda : (randrange(155, 156), randrange(38, 39), randrange(1, 2))
